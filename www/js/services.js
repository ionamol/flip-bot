...
.factory('fireBaseData', function($firebase) {
	var ref = new Firebase("https://flip-bot.firebaseio.com/"),
    refCart = new Firebase("https://flip-bot.firebaseio.com/cart"),
    refUser = new Firebase("https://flip-bot.firebaseio.com/users"),
    refCategory = new Firebase("https://flip-bot.firebaseio.com/category"),
    refOrder = new Firebase("https://flip-bot.firebaseio.com/orders"),
    refFeatured = new Firebase("https://flip-bot.firebaseio.com/featured"),
    refMenu = new Firebase("https://flip-bot.firebaseio.com/menu");
  return {
    ref: function() {
      return ref;
    },
